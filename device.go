...
var (
	FMT_USERAGENT = "38882/10.1.8(1050);Android 8.0.0;%s;%s;102;%s;deviceName:%s %s;clientId:38882;os:Android 8.0.0;brand:%s;model:%s;oem:ihaier;lang:zh-CN;"
	Devices       = []*DeviceInfo{
...
func (di *DeviceInfo) UserAgent() string {
	return fmt.Sprintf(FMT_USERAGENT, di.Brand, di.Model, di.Resolution, di.Brand, di.Model, di.Brand, di.Model)
}
